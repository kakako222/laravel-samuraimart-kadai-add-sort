...
class PostTest extends TestCase
{
    use RefreshDatabase;
     ...
     //ログインした人は新規投稿ページにアクセスできる
     public function test_guest_can_access_posts_create()
     {
        $user = User::factory()->create();
